      ...
      <div className="max-w-2xl w-full">
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              Build Your Career, Find Top Talent
            </motion.p>
          </div>
          ...
          <div className="mb-6">
            ...
            <select 
              ...
              className="input-field w-full p-3 border border-slate-300 rounded-lg text-slate-900"
            >
          ...
          >
            <p className="text-blue-600">
              ...
              <Link href="/login" className="text-blue-700 hover:text-blue-800 font-bold underline underline-offset-2 transition-colors">
                Sign in
              </Link>
            </p>
          </motion.div>
